...
$query=mysqli_query($dbconnect, "SELECT * FROM sell WHERE ProductCategory = 'Toys' ORDER BY SellID DESC LIMIT 20;");
?>
                ...
                <div class="header_wrapper">
                    <header id="HomeHeader">
                        ...
                        <ul>
                            ...
                            <li><a id="link1" href="toys.php" >Toys</a></li>
                            <li>
                            <?php
            ...
            <div id="search_content">
                ...
                if($ProductName == null){
                    echo "<div id='NoProductMSG'>";
                        echo"<h2>Sorry!</h2>";
                        echo"<p>There doesn't seem to be any results for toys</p>";
                    echo "</div>";
                }
                ?>
            </div>
