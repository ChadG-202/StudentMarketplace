...
$query=mysqli_query($dbconnect, "SELECT * FROM sell WHERE ProductCategory = 'Furniture' ORDER BY SellID DESC LIMIT 20;");
?>
            ...
            <div id="search_content">
                ...
                if($ProductName == null){
                    echo "<div id='NoProductMSG'>";
                        echo"<h2>Sorry!</h2>";
                        echo"<p>There doesn't seem to be any results for furniture</p>";
                    echo "</div>";
                }
                ?>
            </div>
